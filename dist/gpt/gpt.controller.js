...
const extract_keywords_dto_1 = require("./dto/extract-keywords.dto");
let GptController = class GptController {
    gptService;
    constructor(gptService) {
        this.gptService = gptService;
    }
    async extractKeywords(dto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [extract_keywords_dto_1.ExtractKeywordsDto]),
    __metadata("design:returntype", Promise)
], GptController.prototype, "extractKeywords", null);
